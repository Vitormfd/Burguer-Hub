ALTER TABLE public.bairros_taxas
...
COMMENT ON COLUMN public.bairros_taxas.frete_gratis_ativo IS
  'Frete grátis sempre neste bairro.';
COMMENT ON COLUMN public.bairros_taxas.frete_gratis_minimo IS
  'Subtotal mínimo para frete grátis neste bairro. NULL ou 0 desativa.';
...
GRANT EXECUTE ON FUNCTION public.calcular_taxa_entrega_efetiva(uuid, public.tipo_entrega, numeric, numeric, boolean, text) TO anon, authenticated;
